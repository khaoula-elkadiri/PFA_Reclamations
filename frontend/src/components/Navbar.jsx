...
import { Search, Bell, BarChart3, Package, User, LogOut, FileText } from 'lucide-react';
  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-links">
        ...
        {isClientLoggedIn() && (
          <>
            <Link to="/rechercher"><Search size={18} /> Nouvelle réclamation</Link>
            <Link to="/suivi"><Bell size={18} /> Suivi</Link>
            <Link to="/mes-reclamations"><FileText size={18} /> Mes réclamations</Link>
            <span className="navbar-user">
              <User size={16} />
        ...
        {!isAgentLoggedIn() && !isClientLoggedIn() && (
          <>
            <Link to="/login/client" className="navbar-link-auth"><User size={18} /> Espace Client</Link>
            <Link to="/login/agent" className="navbar-link-auth navbar-link-agent"><BarChart3 size={18} /> Espace Agent</Link>
          </>
        )}
      </div>
    </nav>
